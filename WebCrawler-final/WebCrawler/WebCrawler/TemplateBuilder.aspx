...
<body onload="Init();">
    ...
    <form id="msform" runat="server">
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanelStep1">
                <ContentTemplate>
                    ...
                    <div style="float:left;">
                        ...
                        <input type="checkbox" class="second" id="selectall" name="check"/>
                        <label for="selectall" class="label2">Select All</label>
                    </div>
                    <div class="clear"></div>
                    <div class="check">
        ...
        <fieldset>
            ...
            <input type="button" name="next" class="next action-button" value="Next" onclick="SetIfNull()" />
            <asp:UpdatePanel runat="server" ID="UpdatePanelStep2">
                <ContentTemplate>
                    ...
                    <table>
                        <tr>
                            <asp:Button runat="server" ID="btnBegin" OnClick="btnBegin_OnClick" CssClass="action-button" Text="Begin Crop Image" Width="215" style="display: none" />
                            ...
                            <asp:Button runat="server" ID="btnCrop" OnClick="btnCrop_OnClick" Text="Crop" OnClientClick="return ValidateSelected();" class="action-button" />
                        </tr>
                        <tr>
                            <td>Original image
        ...
        <fieldset>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                <ContentTemplate>
                    ...
                    <div class="check">
                        <asp:Literal runat="server" ID="lblTemplate"></asp:Literal>
                    </div>
                    <input type="hidden" runat="server" id="templateSelected" value="1" />
                </ContentTemplate>
        ...
        <fieldset>
            ...
            <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                <ContentTemplate>
                    ...
                    <asp:Button type="button" ID="btnPreview" OnClick="btnPreview_OnClick" class="action-button" Width="250px" Text="Creat Template" runat="server" />
                    <div id="drag-drop">
        ...
        <input type="hidden" id="targetImage" runat="server" />
    </form>
    ...
    <script>
        ...
        function getValueUsingClass() {
            ...
            $('#btnBegin').trigger('click');
        }

        function SetIfNull() {
            if ($("#imageCompleted").val() == '' || $("#imageCompleted").val().length == 0) {
                var myvalue = $("#imagelink").val();
                $("#imageCompleted").val(myvalue);
            }
        }
