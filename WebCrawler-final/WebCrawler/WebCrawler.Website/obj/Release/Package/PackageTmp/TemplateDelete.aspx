<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplateDelete.aspx.cs" Inherits="WebCrawler.Website.TemplateDelete" %>
                                                ...
                                                <div class='col_1_of_single1 span_1_of_single1'>
                                                    <div class='view1 view-fifth1'>
                                                        <div class='top_box' style="padding: 0 !important">
                                                            <div class='m_2'>
                                                                Trash date: <span style="color: red"><%# DateTime.Parse(Eval("TrashDate").ToString()).ToShortDateString() %></span>
                                                            </div>
                                                            <div class='grid_img'>
                                                                <div class='css3'>
                                                                    <asp:Image ID="imgImage" CssClass="test" ImageUrl='<%# Eval("TrashImageLink") %>' runat="server" /><br />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
