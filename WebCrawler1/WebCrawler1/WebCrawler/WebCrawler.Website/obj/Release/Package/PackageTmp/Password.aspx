<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Password.aspx.cs" Inherits="WebCrawler.Website.Password" %>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row" id="">
                                <div class="container" style="width: 250px;">
                                        ...
                                        <input type="password" runat="server" id="txtOldPass" class="form-control" placeholder="Old password" />
                                        <input type="password" runat="server" id="txtNewPass" class="form-control" placeholder="New password" required />
                                        <asp:Button class="btn btn-lg btn-primary btn-block" ID="btnChange" Text="Sign in" OnClick="btnChange_OnClick" runat="server" />
